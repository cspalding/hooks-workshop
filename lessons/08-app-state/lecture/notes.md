In old React when we needed state we needed to refactor function components into classes to use various lifecycle hooks. Now with hooks we can use state within a function component!
